...
function drawBack() {
  ...
  if (show == true) {
    ctx.drawImage(gel, carX - 10, carY - 205, 150, 200);
    ctx.fillText("Score + 10!", carX - 20, carY - 215);
    showCount++;
    if (showCount == 120) {
      show = false;
      showCount = 0;
  ...
  if (showM == true) {
    ctx.drawImage(ma, carX - 10, carY - 240, 150, 200); //ajeitar posicao
    ctx.fillText("Score + 10!", carX - 20, carY - 250);
    showCountM++;
    if (showCountM == 120) {
      showM = false;
      showCountM = 0;
